<?php
// 本文档自动生成，仅供测试运行
class SOrdersAction extends Action
{

//http://localhost:9002/index.php/IntelligentMarket/SOrders/getAllSOrders
	...
	public function getAllSOrders() {
		...
		$result = array();
		if (count($list)>0) {
			require_once('class.SOrders.php');
...
public function addSOrders()
	{
		...
		// 下面将数据添加到数据库中
		$sqlExecute = "insert into SOrders
