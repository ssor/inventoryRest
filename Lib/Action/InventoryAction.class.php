...
//		}
	...
	public function deleteProductFromStorage()
	{
		...
		if (count($decodedProducts)>0) {
			...
			for($i=0;$i<count($decodedProducts);$i++)
			{
				...
				$sqlUpdate = "update tbProduct set productStatus = '2' where productID = '$productID';";
				$sqlInsert = "insert into tbProductOutInventory(productID,productName,produceDate,productCategory,descript,OutDate)
                 select productID,productName,produceDate,productCategory,descript, '$datetime' from tbProduct  where productID = '$productID'";
				$product = new Product(
					$product->productID,
					$product->productName,
					$product->produceDate,
	...
	public function addProductToStorage()
	{
		...
		if (count($decodedProducts)>0) {
			...
			for($i=0;$i<count($decodedProducts);$i++)
			{
				$product = $decodedProducts[$i];
				$productID = $product->productID;
				$sqlUpdate = "update tbProduct set productStatus = '1' where productID = '$productID';";
				$product = new Product(
					$product->productID,
					$product->productName,
					$product->produceDate,
	...
	public function addProduct()
	{
		...
		// 下面将数据添加到数据库中
		$sqlExecute = "insert into tbProduct(productID,productName,produceDate,productCategory,descript)
	...
	public function deleteProduct() {
		...
		$sqlSelect = "select productID from tbProduct where productID = '$pID'";
		$MSelect = new Model();
		...
		$sqlDelete = "delete from tbProduct where productID = '$pID'; ";
		$M = new Model();
	...
	public function updateProduct() {
		...
		$sqlUpdate = "update tbProduct set productName='$pName',produceDate = '$pDate'
