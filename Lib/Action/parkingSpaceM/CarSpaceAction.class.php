...
class UserAction extends Action
{
	public function updateUser()
	{
		...
		// 下面将数据添加到数据库中
		$sqlExecute = "update users set 用户名称 = '$userName',用户密码 = '$userCid',真实姓名 = '$userRname'
					,性别 = '$userSex',职业 = '$userJob',生日 = '$userBitrh',照片= '$userPic',地址='$userAdd',
				电话 = '$userTel',籍贯 = '$userJG',余额 = '$userYE',会员等级 = '$carType'  where 用户EPC = '$userEPC';";
		$M = new Model();
	...
	public function getAllUsers() {
		...
		if (C('DB_TYPE')== 'Sqlsrv') {
			// sqlserver
			$sql = "SELECT 用户名称 as userName,用户EPC as userEPC,用户密码 as userCid,真实姓名 as userRname,
					性别 as userSex,职业 as userJob,生日 as userBitrh,照片 as userPic,地址 as userAdd,电话 as userTel,
					籍贯 as userJG,余额 as userYE,会员等级 as carType FROM users;";
	...
	public function getUser()
	{
		...
		if (C('DB_TYPE')== 'Sqlsrv') {
			...
			$sql = "SELECT 用户名称 as userName,用户EPC as userEPC,用户密码 as userCid,真实姓名 as userRname,
					性别 as userSex,职业 as userJob,生日 as userBitrh,照片 as userPic,地址 as userAdd,电话 as userTel,
					籍贯 as userJG,余额 as userYE,会员等级 as carType FROM users where 用户EPC = '$userEPC';";
